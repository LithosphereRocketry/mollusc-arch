module forwarder #(
    ...
    assign fwd_first_used = can_forward & fwd_first_valid & fwd_first_src == src;
    assign fwd_second_used = can_forward & fwd_second_valid & fwd_second_src == src;
