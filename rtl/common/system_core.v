...
module system_core #(
    ...
    // Temporary stubs since memory doesn't exist yet
    ...
    wire wb_mem_err_i = 1'b0;
    wire wb_mem_rty_i = 1'b0;
    wire wb_mem_cyc_o;
    ...
    wire wb_ddrctrl_ack_i = 1'b0; // the WB mux doesn't deal well with unconnected ACK
    wire wb_ddrctrl_err_i = 1'b0;
    wire wb_ddrctrl_rty_i = 1'b0;
    ...
    wb_mux_2 #(CACHE_WIDTH, 32, SEL_WIDTH) hostbus(
        .clk(clk),
        .rst(rst),
    ...
    wb_mux_4 #(32, 32, 4) narrowbus (
        ...
        .wbs0_addr(32'h00000000),
        .wbs0_addr_msk(-1 << $clog2(TCM_SIZE)), // scratch RAM
        ...
        .wbs1_addr_msk(-1 << $clog2(ROM_SIZE)), // boot ROM
    ...
    wb_ram #(
        .ADDR_WIDTH($clog2(TCM_SIZE)),
        .DATA_WIDTH(32),
        .SELECT_WIDTH(4)
    ) tcm(
        .clk(clk),
        .adr_i(wb_sram_adr_o[$clog2(TCM_SIZE)-1:0]),
        .dat_i(wb_sram_dat_o),
        .dat_o(wb_sram_dat_i),
        .we_i(wb_sram_we_o),
        .sel_i(wb_sram_sel_o),
    ...
    wb_ram #(
        .ADDR_WIDTH($clog2(ROM_SIZE)),
        .DATA_WIDTH(32),
        .SELECT_WIDTH(4),
        .INIT_PATH(`ROMPATH)
    ) brom(
        .clk(clk),
        .adr_i(wb_brom_adr_o[$clog2(ROM_SIZE)-1:0]),
        .dat_i(wb_brom_dat_o),
        .dat_o(wb_brom_dat_i),
